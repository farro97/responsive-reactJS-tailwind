...
const Hero = () => {
  ...
  return (
    ...
    gap-10 max-container bg-slate-950"
    >
      <div
      ...
      >
        ...
        <h1 className="mt-10 font-palanquin text-8xl text-white
        max-sm:text-[72px] max-sm:leading:-[82] 
        font-bold">
          <span className="xl:bg-slate-950 xl:whitespace-nowrap relative z-10 pr-10 
          text-white lg:border border-coral-red">
             The New Arrival
          </span>
          <br />
      ...
      bg-hero bg-cover bg-center rounded-[15px]"
      >
        <img
          src={bigShoeImg}
